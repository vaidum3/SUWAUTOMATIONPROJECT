 ...
 * 
 */
package com.suwproject.ActionDriver;
...
public class action extends BaseClass  {
	...
	public boolean switchToFrameByIndex(WebDriver driver,int index) {
		...
		try {
			...
			WebElement wait = new WebDriverWait(driver, Duration.ofSeconds(10)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//iframe")));
